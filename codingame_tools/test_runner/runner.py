"""Runs a solution file against a single test case's input, by shelling out to the appropriate
   ...
   `codingame_tools.test_runner.debug_stdin`.)
   ...
   Shared by `codingame_tools.puzzle_manager` (`CgPuzzleManager.play_local`) and
   `codingame_tools.contribution_manager` (`CgContributionManager.run_local_test`)--nothing here
