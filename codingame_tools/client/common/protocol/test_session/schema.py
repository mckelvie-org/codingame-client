...
from ..contribution.schema import CgHtml, CgStubGenerator
from ..last_activities.schema import CgLastActivityContributor
...
class CgTestSessionContribution(JSONWizardX):
    """Lightweight contribution metadata, as embedded in
       ...
       `CgContribution` (contribution/schema.py)."""
...
class CgTestSessionTestCase(JSONWizardX):
    """A single test case, as embedded in `CgTestSessionQuestionDetails.test_cases`. Unlike
       `CgTestCase` (contribution/schema.py), only references binary IDs for the input/output
...
class CgTestSessionPuzzle(JSONWizardX):
    """Lightweight puzzle metadata, as embedded in `CgTestSession.puzzle`. A much smaller
       summary than `CgLastActivityPuzzle` (last_activities/schema.py)."""
...
__all__ = [
    "CgAvailableLanguage", "CgMultipleLanguagesTestParams", "CgPlayComparison", "CgPlayError",
    "CgPlayRequest", "CgPlayResult", "CgPlayStackFrame", "CgSubmitRequest", "CgTestSession",
    "CgTestSessionAnswer", "CgTestSessionContribution", "CgTestSessionPuzzle",
    "CgTestSessionQuestion", "CgTestSessionQuestionDetails", "CgTestSessionQuestionSummary",
