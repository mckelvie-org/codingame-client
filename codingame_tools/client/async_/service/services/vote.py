...
class CgAsyncVoteServiceHelper(CgAsyncServiceHelper["CgAsyncVoteService"]):
    """Helper methods for CgAsyncVoteService. Currently empty."""


class CgAsyncVoteService(CgAsyncService):
    """Async Vote service endpoint."""

    def __init__(self, client: CgAsyncClient) -> None:
        super().__init__(client, "Vote")
        self.helper = CgAsyncVoteServiceHelper(self)
