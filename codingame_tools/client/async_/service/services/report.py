...
class CgAsyncReportServiceHelper(CgAsyncServiceHelper["CgAsyncReportService"]):
    """Helper methods for CgAsyncReportService."""
    ...
    async def find_report_by_submission_when_ready(
        ...
        """Poll `find_report_by_submission` until grading has finished, adding retry/polling on
           top of the plain `CgAsyncReportService.find_report_by_submission`.
        ...
        Raises:
            CgAuthenticationError, CgAsyncClientHttpError: see `find_report_by_submission`.
