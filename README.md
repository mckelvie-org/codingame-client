...
[![PyPI version](https://img.shields.io/badge/pypi-v1.0.3rc2-blue.svg)](https://test.pypi.org/project/codingame-tools/1.0.3rc2/)
...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/LICENSE)
...
- **[Browser login](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/concepts/authentication.md)** — CodinGame has no API tokens, so `cg login`
  ...
  [profile](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/concepts/profiles.md); a headless `--manual` path exists for CI.

- **[Async client with structured API wrappers](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/client/index.md)** — `CgClient` exposes 22
...
- **[Puzzle manager](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/tools/puzzle-manager.md)** — a local working directory for solving a
...
- **[Contribution manager](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/tools/contribution-manager.md)** — a local working directory for a
...
- **[A CLI exposing all of it](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/cli/index.md)** — 148 commands, from the two workflow groups down
  to one subcommand per raw API method. Nothing is library-only.

- **[Local validation](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/cli/puzzles.md#running-tests)** — run your solution against real test
...
- **[VS Code integration, including debugging](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/cli/debugging.md)** — generated run/debug
...
- **[The protocol, documented](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/client/services.md)** — CodinGame publishes no API spec. Every
...
- **[Documentation for this version](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/index.md)** — concepts, workflow guides, the client
  library, and a [command reference](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/doc/cli/reference/index.md) generated from the CLI itself.
...
MIT. See [LICENSE](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/LICENSE).

---

For development and release workflow, see [CONTRIBUTING.md](https://github.com/mckelvie-org/codingame-tools/blob/v1.0.3-rc.2/CONTRIBUTING.md).
